# RAGshtain — RAG-система для подготовки к техническим собеседованиям

RAGshtain — это Retrieval-Augmented Generation (RAG) система, предназначенная для помощи в подготовке к техническим собеседованиям в IT.  
